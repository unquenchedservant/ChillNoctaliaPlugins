...
DHV Timer bar widget for Noctalia. Connects to ChillClock's local server to display live timer status in the bar, and provides click-driven controls for toggling and switching timers.
